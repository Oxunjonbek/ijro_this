...
<ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
    ...
    <li class="scrollable-container media-list">
        ...
        <?php foreach ($list as $item): ?>
            ...
            <?php if ($role == 'bugalter'): ?>
                ...
                <a class="d-flex justify-content-between"
                   href="<?= \yii\helpers\Url::to(['receipt/no-confirmed', 'type' => 0, 'id' => $item->id]) ?>">
            ...
            <?php elseif ($role == 'buffer'): ?>
                ...
                <a class="d-flex justify-content-between"
                   href="<?= \yii\helpers\Url::to(['packet/not-confirmed', 'id' => $item->id]) ?>">
                    <div class="media d-flex align-items-center">
                        <div class="media-body">
                            <h6 class="media-heading">
                                <span class="text-bold-500">№ <?= $item->id ?> &mdash; <?= $item->product->vendor_code ?> &mdash;  <?= $item->amount ?>шт</span>
        ...
        <!--                                src="-->
        <? //= bu('themes/robust/app-assets/images/portrait/small/avatar-s-16.jpg') ?><!--"-->
        ...
        <!--                                                      src="-->
        <? //= bu('themes/robust/app-assets/images/icon/sketch-mac-icon.png') ?><!--"-->
        <!--                                                      alt="avatar" height="39" width="39"></div>-->
        <!--                    <div class="media-body">-->
        ...
        <!--                        <div class="avatar mr-1 m-0"><img-->
        <!--                                src="-->
        <? //= bu('themes/robust/app-assets/images/portrait/small/avatar-i-7.png') ?><!--"-->
        <!--                                alt="avatar" height="39" width="39"></div>-->
        <!--                    </div>-->
        <!--                    <div class="media-body">-->

...
<?php else: ?>
    <?= GridView::widget([
        ...
        //         'attribute' => 'tadbir_name',
        //         'format' => 'html',
        //         'value'=>['class' => function($company_id){
        //             // $tadbir = Tadbir::find()->where(['company_id'=>$company_id])->all();
        //             $tadbir = ArrayHelper::map(Tadbir::find()->where(['company_id'=>$company_id])->all(), 'id', 'tadbir_name');
        //             return $tadbir;
        //         }
        //     ],
        // ],

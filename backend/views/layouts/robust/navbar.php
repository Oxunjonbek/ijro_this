        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <!--<li class="dropdown nav-item mega-dropdown">
                        ...
                        <ul class="mega-dropdown-menu dropdown-menu row">
                            <li class="col-md-2">
                                ...
                                <div id="mega-menu-carousel-example">
                                    <div><img class="rounded img-fluid mb-1"
                                              src="<?/*= bu('themes/robust/app-assets/images/slider/slider-2.png') */?>"
                                    ...
                                    <li class="menu-list">
                                        <ul>
                                            ...
                                            <li><a href="#"><i class="ft-align-left"></i> Multi level menu</a>
                                                <ul>
                                                    <li><a class="dropdown-item" href="#"><i class="fa fa-file-o"></i>
                                                            Second level</a></li>
                                                    ...
                                                    <li><a class="dropdown-item" href="#"><i class="fa fa-film"></i>
                            ...
                            <li class="col-md-3">
                                <h6 class="dropdown-menu-header text-uppercase"><i class="fa fa-list"></i> Accordion
                                </h6>
                            ...
                            <li class="col-md-4">
                                <h6 class="dropdown-menu-header text-uppercase mb-1"><i class="fa fa-envelope"></i>
                                    Contact Us</h6>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="position-relative has-icon-left">
                                                    ...
                                                    <div class="form-control-position pl-1"><i class="fa fa-user"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <!-- <ul class="nav navbar-nav float-right">
                    ...
                    <li><a href="#" title=""><?= Yii::$app->user->identity->username;?></a></li>

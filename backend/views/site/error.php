                    ...
                    <div class="card-content">
                        <div class="card-body text-center">
                            ...
                            <?php if($exception->statusCode == '404') :?>
                                ...
                                <img class='img-fluid' src="<?= bu('themes/robust/app-assets/images/pages/404.png')?>" alt='404 error'>
                                <div>
                                    ...
                                    <img src="<?= bu('themes/robust/app-assets/images/pages/not-authorized.png')?>" class="img-fluid" alt="not authorized" width="400">
